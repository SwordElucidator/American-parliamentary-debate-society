...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<cucumber>.freeze, ["< 3", ">= 1.3.8"])
      s.add_runtime_dependency(%q<nokogiri>.freeze, ["~> 1.5"])
      s.add_runtime_dependency(%q<railties>.freeze, ["< 5", ">= 3"])
      ...
      s.add_development_dependency(%q<rspec>.freeze, ["<= 3.1", ">= 2.2"])
      ...
      s.add_dependency(%q<cucumber>.freeze, ["< 3", ">= 1.3.8"])
      s.add_dependency(%q<nokogiri>.freeze, ["~> 1.5"])
      s.add_dependency(%q<railties>.freeze, ["< 5", ">= 3"])
      ...
      s.add_dependency(%q<rspec>.freeze, ["<= 3.1", ">= 2.2"])
